...
import io.cooly.crawler.repository.AuthorityRepository;
...
import io.cooly.crawler.service.dto.PasswordChangeDTO;
import io.cooly.crawler.service.dto.UserDTO;
import io.cooly.crawler.web.rest.errors.ExceptionTranslator;
import io.cooly.crawler.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResourceIntTest {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        user.setEmail("john.doe@coolybot.com");
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.email").value("john.doe@coolybot.com"))

...
public class MailService {
    ...
    public MailService(CoolybotProperties coolyProperties, JavaMailSender javaMailSender,
    ...
    public void sendEmail(String to, String subject, String content, boolean isMultipart, boolean isHtml) {
        ...
        try {
            ...
            message.setTo(to);
            message.setFrom(coolyProperties.getMail().getFrom());
    ...
    public void sendEmailFromTemplate(User user, String templateName, String titleKey) {
        ...
        context.setVariable(BASE_URL, coolyProperties.getMail().getBaseUrl());
